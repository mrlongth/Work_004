...
namespace myDLL
{
    public class cUser_group_menu : IDisposable
    {
        ...
        public bool SP_USER_GROUP_MENU_SEL(string strCriteria, ref DataSet ds, ref string strMessage)
        {
            ...
            try
            {
                ...
                oCommand.CommandText = "SP_USER_GROUP_MENU_SEL";
                ...
                ds = new DataSet();
                oAdapter.Fill(ds, "SP_USER_GROUP_MENU_SEL");
                blnResult = true;
            }
            catch (Exception ex)
            {
        ...
        #region SP_USER_GROUP_MENU_MANAGE_SEL
        public bool SP_USER_GROUP_MENU_MANAGE_SEL(string strCriteria, ref DataSet ds, ref string strMessage)
        {
            bool blnResult = false;
            SqlConnection oConn = new SqlConnection();
            SqlCommand oCommand = new SqlCommand();
            ...
            try
            {
                ...
                oCommand.Connection = oConn;
                oCommand.CommandType = CommandType.StoredProcedure;
                oCommand.CommandText = "SP_USER_GROUP_MENU_MANAGE_SEL";
                SqlParameter oParamI_vc_criteria = new SqlParameter("vc_criteria", SqlDbType.NVarChar);
                oParamI_vc_criteria.Direction = ParameterDirection.Input;
                oParamI_vc_criteria.Value = strCriteria;
                oCommand.Parameters.Add(oParamI_vc_criteria);
                oAdapter = new SqlDataAdapter(oCommand);
                ds = new DataSet();
                oAdapter.Fill(ds, "SP_USER_GROUP_MENU_MANAGE_SEL");
                blnResult = true;
            }
            catch (Exception ex)
            {
        ...
        public bool SP_USER_GROUP_MENU_DEL(string puser_group_code, ref string strMessage)
        {
            bool blnResult = false;
            SqlConnection oConn = new SqlConnection();
            SqlCommand oCommand = new SqlCommand();
            ...
            try
            {
                ...
                oCommand.Connection = oConn;
                oCommand.CommandType = CommandType.StoredProcedure;
                oCommand.CommandText = "SP_USER_GROUP_MENU_DEL";
                oCommand.Parameters.Add("puser_group_code", SqlDbType.NVarChar).Value = puser_group_code;
                ...
                ref string strMessage)
        {
            ...
            try
            {
                ...
                oCommand.Connection = oConn;
                oCommand.CommandType = CommandType.StoredProcedure;
                oCommand.CommandText = "SP_USER_GROUP_MENU_INS";
        ...
        #region SP_USER_GROUP_MENU_UPD
        public bool SP_USER_GROUP_MENU_UPD(
                string puser_group_code,
                string pMenuID,
                string pCanView,
                string pCanInsert,
                ...
                ref string strMessage)
        {
            ...
            try
            {
                ...
                oCommand.Connection = oConn;
                oCommand.CommandType = CommandType.StoredProcedure;
                oCommand.CommandText = "SP_USER_GROUP_MENU_UPD";
                oCommand.Parameters.Add("puser_group_code", SqlDbType.VarChar).Value = puser_group_code;
                oCommand.Parameters.Add("pMenuID", SqlDbType.Int).Value = pMenuID;
                oCommand.Parameters.Add("pCanView", SqlDbType.VarChar).Value = pCanView;
                oCommand.Parameters.Add("pCanInsert", SqlDbType.VarChar).Value = pCanInsert;

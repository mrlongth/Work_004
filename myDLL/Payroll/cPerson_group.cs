...
namespace myDLL
{
    public class cPerson_group : IDisposable
    {
    ...
    public bool SP_PERSON_GROUP_SEL(string strCriteria, ref DataSet ds, ref string strMessage)
    {
        ...
        try
        {
            ...
            oCommand.CommandText = "sp_PERSON_GROUP_SEL";
    ...
    #region SP_PERSON_GROUP_REPORT_SEL
    public bool SP_PERSON_GROUP_REPORT_SEL(string strCriteria, ref DataSet ds, ref string strMessage)
    {
        bool blnResult = false;
        SqlConnection oConn = new SqlConnection();
        SqlCommand oCommand = new SqlCommand();
        ...
        try
        {
            ...
            oCommand.Connection = oConn;
            oCommand.CommandType = CommandType.StoredProcedure;
            oCommand.CommandText = "sp_PERSON_GROUP_REPORT_SEL";
            SqlParameter oParamI_vc_criteria = new SqlParameter("vc_criteria", SqlDbType.NVarChar);
            oParamI_vc_criteria.Direction = ParameterDirection.Input;
            oParamI_vc_criteria.Value = strCriteria;
            oCommand.Parameters.Add(oParamI_vc_criteria);
            oAdapter = new SqlDataAdapter(oCommand);
            ds = new DataSet();
            oAdapter.Fill(ds, "sp_PERSON_GROUP_REPORT_SEL");
            blnResult = true;
        }
        catch (Exception ex)
        {
    ...
    #region SP_PERSON_GROUP_INS
    public bool SP_PERSON_GROUP_INS(string pPerson_group_code, string pPerson_group_name, string pActive, string pC_created_by, ref string strMessage)
    {
        bool blnResult = false;
        SqlConnection oConn = new SqlConnection();
        SqlCommand oCommand = new SqlCommand();
        ...
        try
        {
            ...
            oCommand.Connection = oConn;
            oCommand.CommandType = CommandType.StoredProcedure;
            oCommand.CommandText = "sp_PERSON_GROUP_INS";
            // - - - - - - - - - - - -             
            ...
            // - - - - - - - - - - - -             
            SqlParameter oParam_PERSON_GROUP_name = new SqlParameter("Person_group_name", SqlDbType.NVarChar);
            oParam_PERSON_GROUP_name.Direction = ParameterDirection.Input;
            oParam_PERSON_GROUP_name.Value = pPerson_group_name;
            oCommand.Parameters.Add(oParam_PERSON_GROUP_name);
            // - - - - - - - - - - - -             
    ...
    #region SP_PERSON_GROUP_UPD
    public bool SP_PERSON_GROUP_UPD(string pPerson_group_code, string pPerson_group_name, string pActive, string pC_updated_by, ref string strMessage)
    {
        bool blnResult = false;
        SqlConnection oConn = new SqlConnection();
        SqlCommand oCommand = new SqlCommand();
        ...
        try
        {
            ...
            oCommand.Connection = oConn;
            oCommand.CommandType = CommandType.StoredProcedure;
            oCommand.CommandText = "sp_PERSON_GROUP_UPD";
            // - - - - - - - - - - - -             
            SqlParameter oParam_PERSON_GROUP_code = new SqlParameter("Person_group_code", SqlDbType.NVarChar);
            oParam_PERSON_GROUP_code.Direction = ParameterDirection.Input;
            oParam_PERSON_GROUP_code.Value = pPerson_group_code;
    ...
    #region SP_PERSON_GROUP_DEL
    public bool SP_PERSON_GROUP_DEL(string pPerson_group_code, string pActive, string pC_updated_by, ref string strMessage)
    {
        bool blnResult = false;
        SqlConnection oConn = new SqlConnection();
        SqlCommand oCommand = new SqlCommand();
        ...
        try
        {
            ...
            oCommand.Connection = oConn;
            oCommand.CommandType = CommandType.StoredProcedure;
            oCommand.CommandText = "sp_PERSON_GROUP_DEL";
            // - - - - - - - - - - - -             
            SqlParameter oParam_PERSON_GROUP_code = new SqlParameter("Person_group_code", SqlDbType.NVarChar);
            oParam_PERSON_GROUP_code.Direction = ParameterDirection.Input;
            oParam_PERSON_GROUP_code.Value = pPerson_group_code;

...
{
    public partial class budget_receive_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ViewState["sort"] = "budget_receive_doc";
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lblbudget_receive_name = (Label)e.Row.FindControl("lblbudget_receive_name");
               
             

                #region set ImageView
                ImageButton imgView = (ImageButton)e.Row.FindControl("imgView");
                //imgView.Attributes.Add("onclick", "OpenPopUp('950px','350px','94%','แสดงข้อมูลผังงบประมาณ','budget_receive_view.aspx?mode=view&budget_plan_code=" +
                ...
                //imgEdit.Attributes.Add("onclick", "OpenPopUp('900px','350px','90%','แก้ไข" + base.PageDes + "','budget_receive_control.aspx?budget_type=" + this.BudgetType + "&mode=edit&budget_plan_code="
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (!e.CommandName.ToUpper().Equals("SORT"))
            {
                ...
                lblbudget_receive_doc = (Label)gvRow.FindControl("lblbudget_receive_doc");
            }
            switch (e.CommandName.ToUpper())
            {
                case "VIEW":
                    Response.Redirect(string.Format("~/App_Control/budget_receive/budget_receive_control.aspx?mode=view&budget_receive_doc={0}&budget_type={1}", lblbudget_receive_doc.Text, this.myBudgetType));
                    break;
                case "EDIT":
                    Response.Redirect(string.Format("~/App_Control/budget_receive/budget_receive_control.aspx?mode=edit&budget_receive_doc={0}&budget_type={1}", lblbudget_receive_doc.Text, this.myBudgetType));
                    break;
                case "SORT":
        ...
        {
            Response.Redirect(string.Format("~/App_Control/budget_receive/budget_receive_control.aspx?mode=add&budget_type={0}", this.myBudgetType));
        }

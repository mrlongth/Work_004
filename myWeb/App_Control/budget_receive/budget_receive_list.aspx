<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="budget_receive_list.aspx.cs" Inherits="myWeb.App_Control.budget_receive.budget_receive_list"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage20">หมวดรายรับ :</asp:Label>
            </td>
            <td colspan="3">
    ...
    <asp:GridView runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="No.">
             ...
             <asp:TemplateField HeaderText="เลขที่เอกสาร" SortExpression="budget_receive_doc">
                <ItemStyle HorizontalAlign="Left" Wrap="True" Width="5%"></ItemStyle>
                <ItemTemplate>
                    <asp:Label ID="lblbudget_receive_doc" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.budget_receive_doc") %>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>

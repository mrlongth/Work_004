<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="person_manage_list.aspx.cs" Inherits="myWeb.App_Control.person_manage.person_manage_list"
    Title="แสดงข้อมูลตำแหน่งการบริหาร" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage2">รหัสตำแหน่งการบริหาร 
                : </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtperson_manage_code"></asp:TextBox>
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">ตำแหน่งการบริหาร :
                </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtperson_manage_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสตำแหน่งการบริหาร " SortExpression="person_manage_code">
            ...
            <asp:TemplateField HeaderText="ตำแหน่งการบริหาร " SortExpression="person_manage_name">
                <ItemTemplate>

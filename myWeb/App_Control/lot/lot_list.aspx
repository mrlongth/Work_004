<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true" CodeBehind="lot_list.aspx.cs"
    Inherits="myWeb.App_Control.lot.lot_list" Title="แสดงข้อมูลงบประมาณ " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtlot_code"></asp:TextBox>
                <asp:Label ID="lblError" runat="server" CssClass="label_error"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">ชื่องบประมาณ :
                </asp:Label>
            </td>
            <td>
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtlot_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">

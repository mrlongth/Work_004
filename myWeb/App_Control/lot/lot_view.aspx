<%@ Page Language="C#" MasterPageFile="~/Site_popup.Master" AutoEventWireup="true"
    CodeBehind="lot_view.aspx.cs" Inherits="myWeb.App_Control.lot.lot_view" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                &nbsp;<asp:TextBox ID="txtlot_code" runat="server" CssClass="textboxdis" MaxLength="100"
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top" class="style1">
                <font face="Tahoma">&nbsp;<asp:TextBox ID="txtlot_name" runat="server" CssClass="textboxdis"

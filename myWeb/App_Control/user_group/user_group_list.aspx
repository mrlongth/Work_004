<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="user_group_list.aspx.cs" Inherits="myWeb.App_Control.user_group.user_group_list"
    Title="แสดงข้อมูลกลุ่มผู้ใช้งาน" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage2">รหัสกลุ่มผู้ใช้งาน :
                </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txtuser_group_code"></asp:TextBox>
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">กลุ่มผู้ใช้งาน :
                </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txtuser_group_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสกลุ่มผู้ใช้งาน " SortExpression="user_group_code">
                <ItemStyle HorizontalAlign="Center" Width="20%" Wrap="False" />
                <ItemTemplate>
                    <asp:Label ID="lbluser_group_code" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.user_group_code") %>'>
                    </asp:Label>
                </ItemTemplate>
                <ItemStyle Wrap="False" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="กลุ่มผู้ใช้งาน " SortExpression="user_group_name">
                <ItemTemplate>
                    <asp:Label ID="lbluser_group_name" runat="server" Text='<% # DataBinder.Eval(Container, "DataItem.user_group_name") %>'>
                    </asp:Label>
                </ItemTemplate>
            </asp:TemplateField>

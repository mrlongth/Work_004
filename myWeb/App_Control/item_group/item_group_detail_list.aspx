<%@ Page Language="C#" MasterPageFile="~/Site_list.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="item_group_detail_list.aspx.cs" Inherits="myWeb.App_Control.item_group_detail.item_group_detail_list"
    Title="แสดงข้อมูลรายละเอียดหมวดค่าใช้จ่าย" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr>
            <td style="text-align: right; width: 21%;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage2">รหัสรายละเอียดหมวดค่าใช้จ่าย :
                </asp:Label>
            </td>
            <td style="width: 21%;">
                <asp:TextBox runat="server" CssClass="textbox" Width="150px" ID="txtitem_group_detail_code"></asp:TextBox>
            </td>
            <td style="text-align: right; width: 15%;">
                &nbsp;
            </td>
        ...
        <tr>
            ...
            <td colspan="3" style="height: 26px">
                <asp:TextBox runat="server" CssClass="textbox" Width="450px" ID="txtitem_group_detail_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right; width: 21%;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสรายละเอียดหมวดค่าใช้จ่าย " SortExpression="item_group_detail_code">
            ...
            <asp:TemplateField HeaderText="ชื่อรายละเอียดหมวดค่าใช้จ่าย " SortExpression="item_group_detail_name">

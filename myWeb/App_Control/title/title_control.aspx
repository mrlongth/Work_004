...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">
                <font face="Tahoma">
                    <asp:TextBox ID="txttitle_name" runat="server" CssClass="textbox"
        ...
        <tr align="left">
            ...
            <td align="left" colspan="2" nowrap valign="top">&nbsp;</td>
            <td>&nbsp;</td>
        </tr>
        <tr align="left">
            <td align="right" nowrap valign="top" style="height: 25px">&nbsp;</td>
            <td align="left" colspan="2" nowrap valign="top" style="height: 25px">&nbsp;</td>

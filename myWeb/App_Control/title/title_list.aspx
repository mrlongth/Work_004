<%@ Page Language="C#" Debug="true" MasterPageFile="~/Site_list.Master" AutoEventWireup="true"
    CodeBehind="title_list.aspx.cs" Inherits="myWeb.App_Control.title.title_list"
    Title="แสดงข้อมูลคำนำหน้าชื่อ" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table cellpadding="1" cellspacing="1" style="width: 100%">
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage2">รหัสคำนำหน้าชื่อ :
                </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="200px" ID="txttitle_code"></asp:TextBox>
        ...
        <tr>
            <td style="text-align: right;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage1">คำนำหน้าชื่อ :
                </asp:Label>
            </td>
            <td style="width: 578px">
                <asp:TextBox runat="server" CssClass="textbox" Width="499px" ID="txttitle_name"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="text-align: right;">
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder2">
    <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowPaging="True"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="รหัสคำนำหน้าชื่อ " SortExpression="title_code">
                <ItemStyle HorizontalAlign="Center" Width="20%" Wrap="False" />
                <ItemTemplate>
                    <asp:Label ID="lbltitle_code" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.title_code") %>'>
                    </asp:Label>
                </ItemTemplate>
                <ItemStyle Wrap="False" />
            </asp:TemplateField>
            <asp:TemplateField HeaderText="คำนำหน้าชื่อ " SortExpression="title_name">
                <ItemTemplate>

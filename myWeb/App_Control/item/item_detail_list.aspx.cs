...
namespace myWeb.App_Control.item_detail
{
    public partial class item_detail_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','500px','90%','เพิ่ม" + base.PageDes + "','item_detail_control.aspx?budget_type=" + this.BudgetType + "&mode=add&page=0','1');return false;");
            ...
            {
                //   InitcboItem(cboYear.SelectedValue);
        ...
        private void InitcboItem()
        {
            ...
            if (!string.IsNullOrEmpty(cboItem_group_detail.SelectedValue))
            {
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','500px','93%' , 'แสดงข้อมูลรายละเอียดค่าใช้จ่าย' , 'item_detail_control.aspx?mode=view&item_detail_id=" + hdditem_detail_id.Value + "' , '1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','500px','93%' , 'แก้ไข" + base.PageDes + "' , 'item_detail_control.aspx?budget_type=" + this.BudgetType + "&mode=edit&item_detail_id=" +
                                                            hdditem_detail_id.Value + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y' , '1');return false;");

...
{
    public partial class recv_item_list : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                imgNew.Attributes.Add("onclick", "OpenPopUp('800px','350px','96%','เพิ่มข้อมูลรายการรับ/หัก','recv_item_control.aspx?mode=add&page=0','1');return false;");
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            else if (e.Row.RowType.Equals(DataControlRowType.DataRow) || e.Row.RowState.Equals(DataControlRowState.Alternate))
            {
                ...
                Label lblrecv_item_code = (Label)e.Row.FindControl("lblrecv_item_code");
                Label lblrecv_item_name = (Label)e.Row.FindControl("lblrecv_item_name");
                Label lblc_active = (Label)e.Row.FindControl("lblc_active");
                Label lblrecv_item_type = (Label)e.Row.FindControl("lblrecv_item_type");
                DataRowView rowView = (DataRowView)(e.Row.DataItem);
                //string strrecv_item_type = rowView["recv_item_group_type"].ToString();
                ...
                imgView.Attributes.Add("onclick", "OpenPopUp('800px','350px','96%','แสดงข้อมูลรายได้/ค่าใช้จ่าย','recv_item_control.aspx?mode=view&recv_item_code=" + lblrecv_item_code.Text + "','1');return false;");
                ...
                imgEdit.Attributes.Add("onclick", "OpenPopUp('800px','350px','96%','แก้ไขข้อมูลรายได้/ค่าใช้จ่าย','recv_item_control.aspx?mode=edit&recv_item_code="
                    + lblrecv_item_code.Text + "&page=" + GridView1.PageIndex.ToString() + "&canEdit=Y','1');return false;");
                ...
                imgDelete.Attributes.Add("onclick", "return confirm(\"คุณต้องการลบข้อมูล  : " + lblrecv_item_code.Text + " ?\");");
                #endregion

<%@ Page Language="C#" MasterPageFile="~/Site_lov.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="branch_lov.aspx.cs" Inherits="myWeb.App_Control.lov.branch_lov"
    Title="ค้นหาข้อมูลสาขาธนาคาร" %>
    ...
    <table cellpadding="1" cellspacing="0" style="width: 100%" border="0">
        ...
        <tr>
            ...
            <td style="height: 26px">
                &nbsp;<asp:TextBox runat="server" CssClass="textbox" Width="300px" ID="txtbranch_name"></asp:TextBox>
            </td>
        </tr>
    </table>
</asp:Content>

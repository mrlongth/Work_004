<%@ Page Language="C#" MasterPageFile="~/Site_lov.Master" EnableEventValidation="false"
    AutoEventWireup="true" CodeBehind="budget_money_lov_lov.aspx.cs" Inherits="myWeb.App_Control.lov.budget_money_lov_lov" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table cellpadding="1" cellspacing="1" style="width: 100%" border="0">
        ...
        <tr>
            <td style="text-align: right; width: 15%;">
                <asp:Label runat="server" CssClass="label_h" ID="lblPage18">เลขที่เอกสาร : </asp:Label>
            </td>
            <td style="width: 1%;">
                <asp:TextBox runat="server" CssClass="textbox" Width="120px" ID="txtbudget_money_doc"></asp:TextBox>
            </td>
            <td style="width: 15%; text-align: right;" colspan="2">
        ...
        <tr>
            <td style="text-align: right; width: 15%; height: 20px;">
    ...
    <div class="div-lov" style="height: 312px; width: 100%">
        <asp:GridView ID="GridView1" runat="server" CssClass="stGrid" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="เลขที่เอกสาร" SortExpression="budget_plan_code">
                    <ItemStyle HorizontalAlign="Center" Wrap="True" Width="5%"></ItemStyle>
                    <ItemTemplate>
                        <asp:Label ID="lblbudget_money_doc" runat="server" Text='<%# DataBinder.Eval(Container, "DataItem.budget_money_doc") %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
